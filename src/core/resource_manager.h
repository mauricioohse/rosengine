...
enum TextureID {
    ...
    TEXTURE_PORCUPINE_LEFT,
    TEXTURE_PORCUPINE_RIGHT,
    TEXTURE_PORCUPINE_IS_HIT,
    TEXTURE_BALLOON_RED,
...
static const TextureResource GAME_TEXTURES[] = {
    ...
    {"assets/sprites/squirrel/porcupine_left.png", TEXTURE_PORCUPINE_LEFT},
    {"assets/sprites/squirrel/porcupine_right.png", TEXTURE_PORCUPINE_RIGHT},
    {"assets/sprites/squirrel/porcupine_is_hit.png", TEXTURE_PORCUPINE_IS_HIT},
